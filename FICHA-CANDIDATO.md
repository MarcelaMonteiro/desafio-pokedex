...
- Quais variáveis de ambiente são necessárias?
  ...
  Não foi necessário, pois usamos uma API pública para realizar as consultas e popular os dados.
